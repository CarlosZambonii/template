...
if uploaded_file:
    ...
    if opcao == "Folha de Ponto (Justificação)":
        ...
        aplicar_formatacao(ws, "A1:A117", font_size=12, fill_color="8DB3E2")
         ...
         aplicar_formatacao(ws, "C6:S6", border=True, fill_color="CC4125", font_color="FFFFFF")
      
         aplicar_formatacao(ws, "A7:B7", border=True, bold=True, fill_color="FFD966")
         aplicar_formatacao(ws, "A7:B7", border=True, fill_color="D8D8D8")
         aplicar_formatacao(ws, "C7:D7", border=True, fill_color="F9CB9C")
         aplicar_formatacao(ws, "F7:G7", border=True, fill_color="F9CB9C")
         aplicar_formatacao(ws, "I7:J7", border=True, fill_color="F9CB9C")
         aplicar_formatacao(ws, "L7:M7", border=True, fill_color="F9CB9C")
         aplicar_formatacao(ws, "O7:P7", border=True, fill_color="F9CB9C")
         aplicar_formatacao(ws, "Q7:S7", border=True, fill_color="F9CB9C")
         aplicar_formatacao(ws, "E7:E123", fill_color="F6B26B")
         aplicar_formatacao(ws, "H7:H123", fill_color="F6B26B")
         aplicar_formatacao(ws, "K7:K123", fill_color="F6B26B")
         aplicar_formatacao(ws, "N7:N123", fill_color="F6B26B")
